...
# MAPPO 
#  - CASH
# python baselines/MAPPO/mappo_rnn_mpe.py -m ++AGENT_HYPERAWARE=True ++ENV_KWARGS.capability_aware=True ++FC_DIM_SIZE=32 ++GRU_HIDDEN_DIM=32 ++AGENT_HYPERNET_KWARGS.INIT_SCALE=0.2 ++tag=final-mappo-fire
# LN ablation
...
# QMIX
#  - CASH
# python baselines/QLearning/qmix.py -m +alg=qmix_mpe +env=mpe_simple_fire ++env.ENV_KWARGS.capability_aware=True ++alg.AGENT_HYPERAWARE=True ++alg.AGENT_HIDDEN_DIM=64 ++alg.AGENT_HYPERNET_KWARGS.INIT_SCALE=0.2 ++tag=final-qmix-fire
# LN ablation
...
# MAPPO
#  - CASH
# python baselines/MAPPO/mappo_rnn_mpe.py -m ++AGENT_HYPERAWARE=True ++ENV_KWARGS.capability_aware=True ++FC_DIM_SIZE=32 ++GRU_HIDDEN_DIM=32 ++AGENT_HYPERNET_KWARGS.INIT_SCALE=0.2 ++tag=final-mappo-hmt
# LN ablation
...
# QMIX
#  - CASH
# python baselines/QLearning/qmix.py -m +alg=qmix_mpe +env=mpe_simple_transport ++env.ENV_KWARGS.capability_aware=True ++alg.AGENT_HYPERAWARE=True ++alg.AGENT_HIDDEN_DIM=64 ++alg.AGENT_HYPERNET_KWARGS.INIT_SCALE=0.2 ++tag=final-qmix-hmt
# LN ablation
